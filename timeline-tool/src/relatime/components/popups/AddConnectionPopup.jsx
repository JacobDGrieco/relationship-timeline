...
import { handleAddConnection } from "../../utils/graphHelpers.jsx";
	...
	return (
		<div className="popup-overlay">
			<div className="popup">
					...
					<div className="field">
						...
						<div className="connectionImage">
							{nameToImage[connectionSource] ? (
								<img src={nameToImage[connectionSource]} alt={`${connectionSource || "Source"} image`} />
							) : (
					...
					<div className="field">
						...
						<div className="connectionImage">
							{nameToImage[connectionTarget] ? (
								<img src={nameToImage[connectionTarget]} alt={`${connectionTarget || "Target"} image`} />
							) : (
				...
				<input type="text" value={connectionLabel} onChange={(e) => setConnectionLabel(e.target.value)} placeholder="Optional label" />
